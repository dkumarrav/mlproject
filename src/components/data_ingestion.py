...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(os.path.join("notebook", "data", "stud.csv"))  # ✅ OS-independent path
            logging.info("Read the dataset as dataframe")

            os.makedirs(os.path.dirname(self.ingestion_config.train_data_path), exist_ok=True)  # ✅ Prevent errors
